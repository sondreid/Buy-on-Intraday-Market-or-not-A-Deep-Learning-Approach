"""
Copied from source: https://pytorch-forecasting.readthedocs.io/en/latest/_modules/pytorch_forecasting/models/temporal_fusion_transformer/tuning.html#optimize_hyperparameters
"""
...
from pytorch_forecasting import MAE, RecurrentNetwork #TemporalFusionTransformer
...
def rnn_optimize_hyperparameters(
    ...
    **rnn_configuration,
    ...
    def objective(trial: optuna.Trial) -> float:
        ...
        early_stop_callback     = EarlyStopping(                # CUSTOM
            monitor                     = "val_loss",       # CUSTOM
            min_delta                   = 1e-4,             # CUSTOM    
            patience                    = patience,         # CUSTOM
            verbose                     = True,             # CUSTOM
            mode                        = "min")            # CUSTOM
        lr_logger               = LearningRateMonitor()                   # CUSTOM
        default_trainer_kwargs  = dict(
            accelerator         = 'gpu' if torch.cuda.is_available() else 'cpu', # CUSTOM
        ...
        #rnn_configuration["loss"]  = copy.deepcopy(loss)
